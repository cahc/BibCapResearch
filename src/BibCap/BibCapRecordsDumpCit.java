...
public class BibCapRecordsDumpCit {
    ...
    public static void main(String[] arg) throws IOException {
        ...
        BufferedWriter writer = new BufferedWriter( new FileWriter( new File("RecordsToCitationExSelfCit.txt") ));
        ...
        for(Map.Entry<Integer, BibCapRecord> entry : map.entrySet()) {
            ...
            writer.write(entry.getValue().getUT() +"\t" + entry.getValue().getCitationsExclSelf());
            writer.newLine();
            counter++;
        ...
        writer.close();
        store.close();
        System.out.println(counter + "records dumped");
