...
public class InitialTagger
{
    ...
    private static final Pattern JJ2 = Pattern.compile("(^[Ii]nter.*)|(^[nN]on.*)|(^[Dd]is.*)|(^[Aa]nti.*)");
    private static final Pattern JJ3 = Pattern.compile("(.*ful$)|(.*ous$)|(.*ble$)|(.*ic$)|(.*ive$)|(.*est$)|(.*able$)|(.*al$)");

    private static final Pattern NN = Pattern.compile("(.*ness$)|(.*ment$)|(.*ship$)|(^[Ee]x-.*)|(^[Ss]elf-.*)");
    ...
    public static List<WordTag> EnInitTagger4Sentence(HashMap<String, String> DICT, String sentence, boolean useAlternativeTokenizer) {

        List<String> tokens = null;
        if(useAlternativeTokenizer) {

            tokens = Tokenizer.wordsToList(sentence);
        } else {

            tokens = Arrays.asList( sentence.split("\\s+") );
        }
    ...
    public static List<WordTag> SimplePreTaggerForEnglish(HashMap<String, String> DICT, List<String> tokens) {
    ...
    public static void EnInitTagger4Corpus(HashMap<String, String> DICT, String inputRawFilePath, String outFilePath, boolean useAlternativeTokenizer) throws IOException {
        ...
        for (String line; (line = buffer.readLine()) != null;) {
            ...
            for (WordTag st : EnInitTagger4Sentence(DICT, line, useAlternativeTokenizer))
    ...
    public static void VnInitTagger4Corpus(HashMap<String, String> DICT, String inputRawFilePath, String outFilePath) throws IOException
    {
        BufferedReader buffer = new BufferedReader(new InputStreamReader(
                new FileInputStream(new File(inputRawFilePath)), "UTF-8"));
